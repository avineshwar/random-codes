...
class LinkedList {
  ...
  public LLNode getHead() { return head; }

  public void setHead(LLNode head) { this.head = head; }
  ...
  public void addElement(String data) {
    ...
    LLNode tracerNode =
        head; // helps us to reach the last node starting from head
  ...
  public void show() {
    ...
    LLNode tracerNode =
        head; // helps us to traverse the list starting from head
